...
class OptionInterpreter:
    ...
    def func_option(self, args: T.Tuple[str], kwargs: 'FuncOptionArgs') -> None:
        ...
        opt = parser(description, parser_kwargs)
    ...
    def string_parser(self, description: str, kwargs: 'FuncOptionArgs') -> coredata.UserOption:
        value = kwargs.get('value', '')
        return coredata.UserStringOption(description, value, kwargs['yield'])

    @permittedKwargs({'value', 'yield'})
    def boolean_parser(self, description: str, kwargs: 'FuncOptionArgs') -> coredata.UserOption:
    ...
    def combo_parser(self, description: str, kwargs: 'FuncOptionArgs') -> coredata.UserOption:
    ...
    def integer_parser(self, description: str, kwargs: 'FuncOptionArgs') -> coredata.UserOption:
        value = kwargs.get('value')
        if value is None:
    ...
    @permittedKwargs({'value', 'yield', 'choices'})
    def string_array_parser(self, description: str, kwargs: 'FuncOptionArgs') -> coredata.UserOption:
        choices = kwargs.get('choices', [])
    ...
    @permittedKwargs({'value', 'yield'})
    def feature_parser(self, description: str, kwargs: 'FuncOptionArgs') -> coredata.UserOption:
