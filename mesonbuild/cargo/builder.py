...
"""Provides heleprs for building AST
...
def _token(tid: str, filename: str, value: mparser.TV_TokenTypes) -> mparser.Token:
...
def bool(value: int, filename: str) -> mparser.BooleanNode:
    """Build A BooleanNode
...
def array(value: T.List[mparser.BaseNode], filename: str) -> mparser.ArrayNode:
    ...
    """
    args = mparser.ArgumentNode(_token('array', filename, 'what goes here?'))
...
def method(name: str, id_: mparser.IdNode,
    ...
    """
    args = mparser.ArgumentNode(_token('array', id_.filename, 'what goes here?'))
    args.arguments = pos
    if kw:
...
class Builder:
    ...
    def bool(self, value: int) -> mparser.BooleanNode:
        """Build A BooleanNode
