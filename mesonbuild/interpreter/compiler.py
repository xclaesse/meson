...
_HAS_KWS: T.List[KwargInfo] = [REQUIRED_KW.evolve(since='1.1.0', default=False), *_COMMON_KWS]
_HAS_ARGUMENT_KWS: T.List[KwargInfo] = [REQUIRED_KW.evolve(since='1.1.0', default=False)]
...
class CompilerHolder(ObjectHolder['Compiler']):
    ...
    @typed_kwargs('compiler.has_member', *_HAS_KWS)
    ...
    @typed_kwargs('compiler.has_members', *_HAS_KWS)
    ...
    @typed_kwargs('compiler.has_function', *_HAS_KWS)
    ...
    @typed_kwargs('compiler.has_type', *_HAS_KWS)
    ...
    @typed_kwargs('compiler.has_argument', *_HAS_ARGUMENT_KWS)
    ...
    @typed_kwargs('compiler.has_multi_arguments', *_HAS_ARGUMENT_KWS)
    ...
    @typed_kwargs('compiler.has_link_argument', *_HAS_ARGUMENT_KWS)
    ...
    @typed_kwargs('compiler.has_multi_link_argument', *_HAS_ARGUMENT_KWS)
    ...
    @typed_kwargs('compiler.has_function_attribute', *_HAS_ARGUMENT_KWS)
