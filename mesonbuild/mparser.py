...
class BaseNode:
    ...
    colno: int
    filename: str
    end_lineno: int = field(compare=False)
    end_colno: int = field(compare=False)
...
class ElementaryNode(T.Generic[TV_TokenTypes], BaseNode):
    ...
    value: TV_TokenTypes
    bytespan: T.Tuple[int, int] = field(compare=False)
...
class ArgumentNode(BaseNode):
    ...
    arguments: T.List[BaseNode]
    commas: T.List[Token]
    kwargs: T.Dict[BaseNode, BaseNode]
